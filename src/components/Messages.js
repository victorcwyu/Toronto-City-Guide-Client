...
const Messages = () => {
  ...
  useEffect(() => {
    ...
    if (!userData.user) {
      ...
      axios
        .post(
          "https://toronto-city-travel-guide.herokuapp.com/getUserMessages",
          {
  ...
  const sendMessage = (e) => {
    ...
    if (message) {
      ...
      axios
        .post(
          "https://toronto-city-travel-guide.herokuapp.com/updateUserMessages",
          {
            newMessage,
    ...
    <div>
      <Container>
        {userData.contactInfo && (
          <h1>
            Conversation with <span>{userData.contactInfo.contactName}</span>
          </h1>
        )}
