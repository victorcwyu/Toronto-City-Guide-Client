...
function SearchAndMap({ options, onMount, className, onMountProps }) {
  ...
  useEffect(() => {
    ...
    // console.log("hiiiiii", window.google)
    const onLoad = () =>
      setMap(new window.google.maps.Map(ref.current, { ...options }));
      setBounds(new window.google.maps.LatLngBounds(new window.google.maps.LatLng(43.619132, -79.480562), new window.google.maps.LatLng(43.95843, -78.320516)));
      // console.log("lastttt", ref.current)
      // console.log("lastttt", map)
      // setAutocomplete(new window.google.maps.places.Autocomplete(ref.current, { ...options }));
      ...
      // var bounds = new window.google.maps.LatLngBounds(new window.google.maps.LatLng(43.619132, -79.480562), new window.google.maps.LatLng(43.95843, -78.320516));
      // setBounds(new window.google.maps.LatLngBounds(new window.google.maps.LatLng(43.619132, -79.480562), new window.google.maps.LatLng(43.95843, -78.320516)));
    ...
    // setPlaces(new window.google.maps.places.PlacesService(map));
...
export default React.memo(SearchAndMap, shouldNotUpdate);
